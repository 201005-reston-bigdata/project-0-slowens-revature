...
case class User(val _id: ObjectId=new ObjectId(), var firstName:String, var lastName:String,var callSign:String,var city:String,var state:String) {
  ...
  def apply(_id: ObjectId, first: String, last: String, call: String, city: String, state: String): User = {
    User( _id, first.capitalize, last.capitalize, call.toUpperCase, city.capitalize, state.toUpperCase);
  }
